...
// 第一次绑定了onClick事件 "a"    el._vei = {onClick: invoker}  el.addEventListener(click, e => a(e))
// 第二次绑定了onClick事件 "b"    el._vei = {onClick: invoker}  el.addEventListener(click, e => b(e))
// 第三次绑定了onClick事件 null   el.removeEventListener(click, e => b(e))  el._vei ={onClick: undefined}
